...
#rtc.DS3231_SetTime(NowTime = b'\x00\x52\x07\x21\x26\x05\x22')    #remove comment to set time. Do this only once otherwise time will be set everytime the code is executed.
